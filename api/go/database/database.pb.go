...
const (
	...
	// API_TRACKER is the github.com/minkezhang/tracker database, i.e. the
	// local user list.
	API_API_TRACKER API = 1
	API_API_MAL     API = 2
)
...
var file_database_proto_rawDesc = []byte{
	...
	0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x18, 0x2e, 0x74, 0x72, 0x61, 0x63, 0x6b, 0x65, 0x72, 0x2e,
	...
	0x72, 0x73, 0x18, 0x04, 0x20, 0x03, 0x28, 0x0e, 0x32, 0x1a, 0x2e, 0x74, 0x72, 0x61, 0x63, 0x6b,
	0x65, 0x72, 0x2e, 0x64, 0x61, 0x74, 0x61, 0x62, 0x61, 0x73, 0x65, 0x2e, 0x50, 0x72, 0x6f, 0x76,
	...
	0x1e, 0x2e, 0x74, 0x72, 0x61, 0x63, 0x6b, 0x65, 0x72, 0x2e, 0x64, 0x61, 0x74, 0x61, 0x62, 0x61,
	...
	0x18, 0x07, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1d, 0x2e, 0x74, 0x72, 0x61, 0x63, 0x6b, 0x65, 0x72,
	...
	0x0b, 0x32, 0x1e, 0x2e, 0x74, 0x72, 0x61, 0x63, 0x6b, 0x65, 0x72, 0x2e, 0x64, 0x61, 0x74, 0x61,
	...
	0x65, 0x6f, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1e, 0x2e, 0x74, 0x72, 0x61, 0x63, 0x6b,
	0x65, 0x72, 0x2e, 0x64, 0x61, 0x74, 0x61, 0x62, 0x61, 0x73, 0x65, 0x2e, 0x54, 0x72, 0x61, 0x63,
	...
	0x2e, 0x74, 0x72, 0x61, 0x63, 0x6b, 0x65, 0x72, 0x2e, 0x64, 0x61, 0x74, 0x61, 0x62, 0x61, 0x73,
	...
	0x54, 0x52, 0x41, 0x43, 0x4b, 0x45, 0x52, 0x10, 0x01, 0x12, 0x0b, 0x0a, 0x07, 0x41, 0x50, 0x49,
	...
	0x6e, 0x67, 0x2f, 0x74, 0x72, 0x61, 0x63, 0x6b, 0x65, 0x72, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x67,
...
var file_database_proto_goTypes = []interface{}{
	(API)(0),             // 0: tracker.database.API
	(Corpus)(0),          // 1: tracker.database.Corpus
	(Provider)(0),        // 2: tracker.database.Provider
	(*Database)(nil),     // 3: tracker.database.Database
	(*Entry)(nil),        // 4: tracker.database.Entry
	(*AuxDataGame)(nil),  // 5: tracker.database.AuxDataGame
	(*AuxDataVideo)(nil), // 6: tracker.database.AuxDataVideo
	(*AuxDataAudio)(nil), // 7: tracker.database.AuxDataAudio
	(*AuxDataBook)(nil),  // 8: tracker.database.AuxDataBook
	(*TrackerVideo)(nil), // 9: tracker.database.TrackerVideo
	(*TrackerBook)(nil),  // 10: tracker.database.TrackerBook
	nil,                  // 11: tracker.database.Database.EntriesEntry
}
var file_database_proto_depIdxs = []int32{
	11, // 0: tracker.database.Database.entries:type_name -> tracker.database.Database.EntriesEntry
	1,  // 1: tracker.database.Entry.corpus:type_name -> tracker.database.Corpus
	2,  // 2: tracker.database.Entry.providers:type_name -> tracker.database.Provider
	6,  // 3: tracker.database.Entry.aux_data_video:type_name -> tracker.database.AuxDataVideo
	8,  // 4: tracker.database.Entry.aux_data_book:type_name -> tracker.database.AuxDataBook
	5,  // 5: tracker.database.Entry.aux_data_game:type_name -> tracker.database.AuxDataGame
	7,  // 6: tracker.database.Entry.aux_data_audio:type_name -> tracker.database.AuxDataAudio
	9,  // 7: tracker.database.Entry.tracker_video:type_name -> tracker.database.TrackerVideo
	10, // 8: tracker.database.Entry.tracker_book:type_name -> tracker.database.TrackerBook
	4,  // 9: tracker.database.Database.EntriesEntry.value:type_name -> tracker.database.Entry
