...
var file_database_proto_rawDesc = []byte{
	...
	0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x99, 0x05, 0x0a, 0x05, 0x45, 0x6e, 0x74, 0x72,
	0x79, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69,
	0x64, 0x12, 0x12, 0x0a, 0x04, 0x65, 0x74, 0x61, 0x67, 0x18, 0x0d, 0x20, 0x01, 0x28, 0x0c, 0x52,
	0x04, 0x65, 0x74, 0x61, 0x67, 0x12, 0x30, 0x0a, 0x06, 0x63, 0x6f, 0x72, 0x70, 0x75, 0x73, 0x18,
...
var file_database_proto_goTypes = []interface{}{
	...
	(*Entry)(nil),        // 4: truffle.database.Entry
	(*AuxDataGame)(nil),  // 5: truffle.database.AuxDataGame
	(*AuxDataVideo)(nil), // 6: truffle.database.AuxDataVideo
	(*AuxDataAudio)(nil), // 7: truffle.database.AuxDataAudio
	(*AuxDataBook)(nil),  // 8: truffle.database.AuxDataBook
	(*TrackerVideo)(nil), // 9: truffle.database.TrackerVideo
	(*TrackerBook)(nil),  // 10: truffle.database.TrackerBook
	nil,                  // 11: truffle.database.Database.EntriesEntry
}
var file_database_proto_depIdxs = []int32{
	11, // 0: truffle.database.Database.entries:type_name -> truffle.database.Database.EntriesEntry
	1,  // 1: truffle.database.Entry.corpus:type_name -> truffle.database.Corpus
	2,  // 2: truffle.database.Entry.providers:type_name -> truffle.database.Provider
	6,  // 3: truffle.database.Entry.aux_data_video:type_name -> truffle.database.AuxDataVideo
	8,  // 4: truffle.database.Entry.aux_data_book:type_name -> truffle.database.AuxDataBook
	5,  // 5: truffle.database.Entry.aux_data_game:type_name -> truffle.database.AuxDataGame
	7,  // 6: truffle.database.Entry.aux_data_audio:type_name -> truffle.database.AuxDataAudio
	9,  // 7: truffle.database.Entry.tracker_video:type_name -> truffle.database.TrackerVideo
	10, // 8: truffle.database.Entry.tracker_book:type_name -> truffle.database.TrackerBook
	4,  // 9: truffle.database.Database.EntriesEntry.value:type_name -> truffle.database.Entry
